...
def get_model_and_assets():
  ...
  return (resources.GetResource(f'{current_dir}/point_velocity.xml'),
          common.ASSETS)
...
class Point(base.Task):
  ...
  def before_step(self, action, physics):
    ...
    # NOTE: stop manually forcing velocity. Creates bug with wall collisions
    #if self.velocity:
...
if __name__ == '__main__':
  ...
  env = make('velocity', task_kwargs=None,
             environment_kwargs=None,
